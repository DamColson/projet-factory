...
public interface IDAOStagiaire extends JpaRepository<Stagiaire, Integer> {
	...
	@Query("update Stagiaire s set s.formation=null where s.formation=:formation and s.id=:id")
	@Modifying
	@Transactional
	public void setFormationNull(@Param("formation") Formation formation,@Param("id")Integer id);
}
